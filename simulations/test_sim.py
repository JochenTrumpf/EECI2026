...
from filters.GPS_INS_EKF import GPS_INS_EKF
...
class test_sim(sim):
    ...
    def __init__(self, params: test_sim.parameters, config: test_sim.configuration, 
                 robot_data: list[tuple[simple_quad, INS_robot_state]]):
        # override parent class types
        self.params: test_sim.parameters
        self.config: test_sim.configuration
